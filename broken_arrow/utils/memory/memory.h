...
#define GAMEASSEMBLY_DLL		XOR_STR( L"GameAssembly.dll" )
#define UNITYPLAYER_DLL			XOR_STR( L"UnityPlayer.dll" )
#define GAMEOVERLAYRENDERER_DLL XOR_STR( L"gameoverlayrenderer.dll" )
#pragma endregion
